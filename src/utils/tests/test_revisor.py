...
from ...routers.reviser import device_access, device_calendar, device_mail, device_mstream, device_name, device_ntp, device_dst, device_overlay, device_quota, device_record, device_sderror, device_security, device_dns, device_sstream, device_motion, device_sd
...
async def test_device(mocker, mock_device):
    conf_path = Path('src') / 'utils' / 'configurations' / f'{mock_device()['model']}.json'
    ...
    #Mocked NTP
    instance.getntp.return_value = {'server': conf['ntp']['server'],
                                     'sync': conf['ntp']['sync']
                                     }
    ...
    #Mocked DST
    instance.getdst.return_value = {"mode": conf['dst']['mode'], 
    ...
    #Mocked Security
    instance.getsec.return_value = {'web_sec': conf['security']['web'], 
    ...
    #Mocked DNS
    instance.getdns.return_value = {'primary': conf['dns']['primary'], 
    ...
    #Mocked Mail
    instance.getmail.return_value = {'name': f'{mock_device()['name']} {mock_device()['installation']}', 
    ...
    #Mocked Main-Stream
    instance.getmstream.return_value = {'name': mock_device()['name'], 
    ...
    #Mocked Sub-Stream
    instance.getsstream.return_value = {'name': mock_device()['name'], 
    ...
    #Mocked Overlays
    instance.getoverlay.return_value = {'week': conf['overlays']['week'], 
    ...
    #Mocked Motion
    instance.getmotion.return_value = {'enabled': conf['motion']['enabled'], 
    ...
    #Mocked Motion
    instance.getrecord.return_value = {'target': conf['record']['target'], 
    ...
    #Mocked SD Quota
    instance.getquota.return_value = {'picture': conf['quota']['picture'], 
    ...
    #Mocked Calendar
    instance.getcalendar.return_value = {'enabled': conf['calendar']['enabled'], 
                                         'advanced': {'overwrite': conf['calendar']['advanced']['overwrite'], 
                                         ...
                                         'schedule': {'start': {'Monday': conf['calendar']['schedule']['Monday']['start'], 
                                                      ...
                                                      'end': {'Monday': conf['calendar']['schedule']['Monday']['end'], 
                                                      ...
                                                      'mode': {'Monday': conf['calendar']['schedule']['Monday']['mode'], 
